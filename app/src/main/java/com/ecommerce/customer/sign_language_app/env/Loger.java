...
package mquinn.sign_language.env;
...
public final class Loger {
    ...
    static {
        ...
        IGNORED_CLASS_NAMES.add(Loger.class.getCanonicalName());
    }
     ...
     */
    public Loger(final Class<?> clazz) {
     ...
     */
    public Loger(final String messagePrefix) {
     ...
     *     being used
     */
    public Loger(final String tag, final String messagePrefix) {
        this.tag = tag;
    ...
    /** Creates a Logger using the caller's class name as the message prefix. */
    public Loger(final int minLogLevel) {
        this(DEFAULT_TAG, null);
    ...
    private static String getCallerSimpleName() {
        ...
        return Loger.class.getSimpleName();
    }
